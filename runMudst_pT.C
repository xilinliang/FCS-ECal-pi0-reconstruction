void runMudst_pT(char* file="st_cosmic_adc_22326042_raw_0000005.MuDst.root", 
	      int ifile=-1, Int_t nevt=20, char* outdir=".", int readMuDst=1, int debug=0){  
    gROOT->Macro("Load.C");
...
//    fcsPi0Finder->st(1);
    ...
    gSystem->Load("StFcsPi0FinderForEcal_pT");
    StFcsPi0FinderForEcal_pT* fcsPi0Finder_pT = new StFcsPi0FinderForEcal_pT();
    fcsPi0Finder_pT->st(1);
