...
#ifndef STAR_StFcsPi0FinderForEcal_pT_HH
#define STAR_StFcsPi0FinderForEcal_pT_HH
...
class StFcsPi0FinderForEcal_pT : public StMaker {
  public:
   StFcsPi0FinderForEcal_pT(const Char_t* name = "FcsPi0F");
   ~StFcsPi0FinderForEcal_pT();
   Int_t Init();
   Int_t Make();
   Int_t Finish();
   void st(Int_t run2) { filename = Form("StFcsPi0invariantmass_bestpT_%i.root", run2); };
  ...
  private:
   ...
   TH1F* h1_inv_mass_cluster_allcom = 0;           //h1_inv_mass_cluster_allcom:invariant mass for all possible combined pair
   ...
   TH1F* h1_two_cluster_pT_allcut=0;		//h1_two_cluster_pT_allcut: cluster pair pT sum;
...
#ifndef SKIPDefImp
   ClassDef(StFcsPi0FinderForEcal_pT, 0)
#endif
};
