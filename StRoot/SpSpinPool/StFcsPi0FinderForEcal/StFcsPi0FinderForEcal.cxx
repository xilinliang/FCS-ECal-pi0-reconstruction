...
Int_t StFcsPi0FinderForEcal::Init() {
   ...
   h1_inv_mass_cluster_Vvpd= new TH1F("h1_inv_mass_cluster_Vvpd", "invariant mass plot for FCS ECal cluster (VPD vertex)", bins, m_low, m_up);
   h1_inv_mass_cluster_Vvpd->SetXTitle("invariant mass [GeV]");
   h1_inv_mass_cluster_Vbbctpc= new TH1F("h1_inv_mass_cluster_Vbbctpc", "invariant mass plot for FCS ECal cluster (BBC vertex) with TPC vertex exist", bins, m_low, m_up);
   h1_inv_mass_cluster_Vbbctpc->SetXTitle("invariant mass [GeV]");
   h1_inv_mass_cluster_Vvpdtpc= new TH1F("h1_inv_mass_cluster_Vvpdtpc", "invariant mass plot for FCS ECal cluster (VPD vertex) with TPC vertex exist", bins, m_low, m_up);
